    ...
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-3">
          ...
          <Button onClick={applyPriceFilter} className="w-full bg-emerald-600 hover:bg-emerald-700 text-white">
            Aplicar Filtro
          </Button>
        </div>
      </div>
    ...
    <div className="min-h-screen mx-auto border border-gray-200 w-full">
      ...
      <div className="bg-white border-b">
        <div className="container mx-auto px-4 py-6 md:py-8">
          <h1 className="text-2xl md:text-4xl font-bold text-gray-900 mb-2">Catálogo</h1>
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm mb-4 md:mb-6">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div className="flex items-center gap-4 w-full sm:w-auto">
                  ...
                  <div className="text-gray-600 text-sm">{products.length} produtos encontrados</div>
                </div>
                  ...
                  <Card className="group cursor-pointer border-0 shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden h-full flex flex-col">
                    <div className="relative flex-shrink-0">
                      ...
                      <div className="absolute top-2 left-2 flex flex-col gap-1">
                        {product.isNew && <Badge className="bg-emerald-500 text-white text-xs">Novo</Badge>}
                        {product.isSale && <Badge className="bg-red-500 text-white text-xs">Promoção</Badge>}
                      </div>
                    </div>
